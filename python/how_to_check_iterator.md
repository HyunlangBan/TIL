...
'isupper', 'join', 'ljust', 'lower', 'lstrip', 'maketrans', 'partition', 'replace', 'rfind', 'rindex', 'rjust', 'rpartition', 'rsplit', 'rstrip', 
...
'__rand__', '__rdivmod__', '__reduce__', '__reduce_ex__', '__repr__', '__rfloordiv__', '__rlshift__', '__rmod__', '__rmul__', '__ror__', '__round__', '__rpow__',
'__rrshift__', '__rshift__', '__rsub__', '__rtruediv__', '__rxor__', '__setattr__', '__sizeof__', '__str__', '__sub__', '__subclasshook__', '__truediv__', 
...
##  `hasattr()`
```python
>>> print(hasattr(a, '__iter__'))   # a = 'Hello'
True

>>> print(hasattr(b, '__iter__'))   # b = 45
False
```
...
>>> print(isinstance(a, abc.Iterable))   # a = 'Hello'
True

>>> print(isinstance(b, abc.Iterable))   # b = 45
False
```
